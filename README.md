...
- For Server variants: The whole installation is done in text mode. You have just to press enter when requested to reboot and start the installed system. Remember to change the root password!
